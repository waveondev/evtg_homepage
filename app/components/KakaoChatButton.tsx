...
export default function KakaoChatButton() {
    const handleChat = () => {
        // 여기에 대표님의 채널 홈 ID를 입력하세요 (예: _xcvbn)
        const channelId = '_mDixhX';
    ...
    return (
        ...
        >
            <svg width="30" height="30" viewBox="0 0 24 24" fill="#3C1E1E">
                <path d="M12 3C6.477 3 2 6.48 2 10.791c0 2.763 1.833 5.187 4.59 6.611l-.914 3.37c-.12.443.344.823.727.568l4.037-2.686c.51.05 1.03.076 1.56.076 5.523 0 10-3.48 10-7.791S17.523 3 12 3z"/>
            </svg>
        </div>
    );
}
